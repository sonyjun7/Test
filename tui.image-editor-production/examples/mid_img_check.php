...
<body>
    ...
    <div class="polaroid">
        ...
        <div class="container">
            ...
            <div>
                <button class="btn btn-success btn-lg" value="닫기" style="width:100%; max-width:200px; margin-left:30px;" onclick="window.close()">닫기</button>
            </div>
        </div>
    </div>
    ...
    <script src="../dist/mid_image_watch.js"></script>
</body>
</html>
