...
<html lang="ko">
    ...
    <?php
            $chfile = mq("select * from scenario_info_mid where id='".$session."' and idx='".$idx."'");
    ...
    ?>
        ...
        <a id="check_a"><button class="btn btn-success">업로드 이미지 확인</button></a>
        <button id="refresh_btn" class="btn btn-success">새로고침(이미지 변경시 새로고침 해주세요)</button>
        ...
        <script type="text/javascript" src="../dist/mid_tui-image-editor.js"></script>
        ...
        <script src='../dist/mid_prev_image_delete.js'></script>
        <!-- 이미지 파일을 업로드하는 js 파일 -->
        <script src='../dist/mid_image_firebase.js'></script>
    </body>
</html>
<?php
    }
