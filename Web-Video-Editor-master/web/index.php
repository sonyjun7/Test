...
<div style="float: right;">
	...
	<a id="check_b"><button class="btn btn-primary">업로드 영상 확인</button></a>
	<button id="refresh_btn" class="btn btn-primary">새로고침(동영상 변경시 새로고침 해주세요)</button>
...
<div id="resizable" class="ui-widget-content">
	<video  id="vdid" class="video" loop muted></video>
...
<script src="./prev_movie_delete.js"></script>
</body>
</html>
<?php
	}
