...
<body>
    ...
    <div id="hNotice">
        <h2><?php echo $session ?>님의 초등시나리오 정보 확인</h2>
    ...
    <div id="sce_div">
        ...
        <form  id="form_el" action="sceResult.php" method="post">
        <?php
            $sql1 = mq("select * from scenario_info where id='".$session."' order by idx");
        ...
        <div id="sce_btn_div">
            <button id="sce_mod_btn" class="btn btn-primary">시나리오 순서 수정하기</button>
        </div>
    ...
    <script src="./delete_firebase_file.js"></script>
</body>
</html>
<?php
