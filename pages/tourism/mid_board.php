...
<body>
    ...
    ?>
    <div id="hNotice">
        <h2>중등 <?php echo $subject ?> 관광지 정보 게시판</h2>
    ...
    <div id="elboard_area">
        ...
        <table class="table table-hover" id="el_table">
            ...
            <?php
                $sql = mq("select * from midtable where subject='".$subject."'");
                
                while($midboard = $sql -> fetch_array()){
            ?>

            <tbody>
                <tr>
                    <td width="30%"><img src="../../img/mid_img/<?php echo $midboard['thumbnail'] ?>"></td>
                    <td width="30%"><a href="./mid_content.php?idx=<?php echo $midboard['idx'] ?>&title=<?php echo $midboard['title'] ?>"><?php echo $midboard['title'] ?></a></td>
                    <td width="10%"><?php echo $midboard['linetype'] ?></td>
                    <td width="10%"><?php echo $midboard['hit'] ?></td>
                </tr>
            </tbody>
    <?php
        }
    ...
    ?>
    <div id="btn_board">
        <a href="./mid_upload.php?subject=<?php echo $subject ?>"><button class="btn btn-primary">중등 관광지 업로드</button></a>
    </div>
    <?php
        }
    ?>
    ...
    <?php
        $sql = mq("alter table midtable AUTO_INCREMENT = 1");
        $sql = mq("set @COUNT = 0");
        $sql = mq("update midtable set idx=@COUNT:=@COUNT + 1");
    ?>
