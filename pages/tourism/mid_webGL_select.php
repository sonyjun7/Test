...
<body>
    ...
    <div id="el_sel1">
        <a href="./mid_webgl_type.php?subject=society"><button class="btn btn-warning">사회과<br>웹 체험</button></a>
        <a href="./mid_webgl_type.php?subject=lang"><button class="btn btn-warning">국어과<br>웹 체험</button></a>
        <a href="./mid_webgl_type.php?subject=geo"><button class="btn btn-warning">지리과<br>웹 체험</button></a>
    </div>

    <div id="el_sel2">
        <a href="./mid_webgl_type.php?subject=sci"><button class="btn btn-warning">과학과<br>웹 체험</button></a>
        <a href="./mid_webgl_type.php?subject=art"><button class="btn btn-warning">미술과<br>웹 체험</button></a>
    </div>
