...
<body>
    ...
    <div id="el_sel1">
        <a href="./el_board.php?subject=society"><button class="btn btn-primary">사회과</button></a>
        <a href="./el_board.php?subject=language"><button class="btn btn-primary">국어과</button></a>
        <a href="./el_board.php?subject=geography"><button class="btn btn-primary">지리과</button></a>
    </div>

    <div id="el_sel2">
        <a href="./el_board.php?subject=science"><button class="btn btn-primary">과학과</button></a>
        <a href="./el_board.php?subject=art"><button class="btn btn-primary">미술과</button></a>
    </div>
