...
<body>
    ...
    <div id="write_area">
        <form action="./mid_upload_ok.php?subject=<?php echo $subject ?>" method="post" enctype="multipart/form-data">
            <div id="write_title">
                <div id="title1">
                   * 제목
                </div>
                <div id="title2">
                    <textarea name="mid_title" class="form-control" placeholder="제목을 입력해주세요" required></textarea>
                </div>
            ...
            <div id="write_content">
                ...
                체험/혼합
                 ...
                 <div id="title_cont2">
                    <textarea name="mid_linetype" class="form-control" placeholder="체험형 / 혼합형 선택" required></textarea>
                 </div>
            </div>
            ...
            <div id="write_content_sub">
                <div id="title_cont1_sub">
                 ...
                 <div id="title_cont2_sub">
                    <textarea name="mid_content" id="idcont" class="form-control" placeholder="내용을 입력해주세요" required></textarea>
                 </div>
            </div>
            ...
            <div id="write_content">
                <div id="img_cont1">
                 ...
                 <div id="img_cont2">
                    <div id="in_file">
                        <input type="file" value="1" name="mid_thumb" id="upload_button1" accept="image/*" onchange="chk_file_type(this)">
            ...
            <div id="write_content">
                <div id="img_cont1">
                 ...
                 <div id="img_cont2">
                    <div id="in_file">
                        <input type="file" value="1" name="mid_img360" id="upload_button2" accept="image/*" onchange="chk_file_type(this)">
