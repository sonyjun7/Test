...
<?php
        ...
        $coseq = mq("select * from scenario_info where id='".$sceid."' and idx='".$idx."'");
    ...
    <div id="cosebtn_area">
        ...
        <a href="./scenario_view_notice.php"><button class="btn btn-primary">시나리오 게시판</button></a>
        <button id="back_cose" class="btn btn-primary">코스 목록</button>
    </div>
    ...
    <script src="../../tui.image-editor-production/dist/image_watch.js"></script>
    <script src="../../Web-Video-Editor-master/web/video_watch_firebase.js"></script>
</body>
</html>
<?php
