<?php
    ...
    setcookie("el_sce_". $idx, "" , time() - 86400, "/");
    ...
    $mq1 = mq("delete from scenario_info where id='".$session."'");
    $mq2 = mq("delete from scenario_post where id='".$session."'");
...
<script src="./all_drop_cose_firebase.js"></script>
<!-- <script>
