...
<body>
    ...
    <div id="hNotice">
        ...
        <h4><a href="./mid_scenario_view_notice.php">메인 게시판으로 돌아가기</a></h4>
    </div>
    ...
    <div id="board_area">
        ...
        <table id="list_table" class="table table-hover">
            ...
            <?php
                ...
                $sql1 = mq("select * from scenario_post_mid where $category like '%$search%' order by post_idx desc");
                ...
                $sql2 = mq("select * from scenario_post_mid where $category like '%$search%' order by post_idx desc limit $start_num, $list");                                         
