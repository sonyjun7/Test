...
<body>
    ...
    <div id="board_area">
        ...
        <table id="list_table" class="table table-hover">
            ...
            <?php
                ...
                $sql = mq("select * from scenario_post");
                ...
                $sql2 = mq("select * from scenario_post order by post_idx desc limit $start_num, $list");                                         
    ...
    <?php
        ...
        $sql2 = mq("alter table scenario_post AUTO_INCREMENT = 1");
        $sql2 = mq("set @COUNT = 0");
        $sql2 = mq("update scenario_post set post_idx = @COUNT:=@COUNT + 1");
    ?>
