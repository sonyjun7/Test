...
<?php
        ...
        $coseq = mq("select * from scenario_info_mid where id='".$session."' and idx='".$idx."'");
    ...
    <div id="sce_area">
        ...
        <form action="./mid_scenario_course_ok.php?idx=<?php echo $idx ?>" method="post" id="cose_form">
            <div id="title_area">
                <div id="tit1_cose">
                    <h4>제목</h4>
                </div>
        ...
        <div id="upload_div">
            ...
            <div id="edit_div">
                <a href="../../tui.image-editor-production/examples/mid_directions.php?idx=<?php echo $idx ?>" onClick="window.open(this.href, '', 'width=900, height=900'); return false;" target="_blank"><button id="edit_btn" class="btn btn-success">이미지 편집 후 업로드</button></a>
                
                <a href="../../Web-Video-Editor-master/web/mid_instructions.php?idx=<?php echo $idx ?>" onClick="window.open(this.href, '', 'width=900, height=900'); return false;" target="_blank"><button id="edit_vid" class="btn btn-success">영상 편집 후 업로드</button></a>
            </div>

            <div id="edit_div">
                <a href="../../tui.image-editor-production/examples/mid_img_check.php?idx=<?php echo $idx ?>" onClick="window.open(this.href, '', 'width=900, height=700'); return false;" target="_blank"><button id="edit_btn" class="btn btn-success">이미지 확인</button></a>

                <a href="../../Web-Video-Editor-master/web/mid_video_check.php?idx=<?php echo $idx ?>" onClick="window.open(this.href, '', 'width=900, height=700'); return false;" target="_blank"><button class="btn btn-success">영상 확인</button></a>
            </div>
    ...
    <div id="cosebtn_area">
        ...
        <a href="./mid_scenarioWrite.php"><button class="btn btn-info">코스 확인</button></a>
    ...
    <script>
        ...
        $("#cose_drop").click(function(){
            if(confirm("현재 코스의 내용 및 파일들을 지우시겠습니까?.")){
                location.href="./mid_course_delete.php?idx=<?php echo $idx ?>";
            }
            else{
                return false;
            }
